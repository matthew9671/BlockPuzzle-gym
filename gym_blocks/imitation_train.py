...
import config
from imitation_rollout import RolloutImitator
...
def launch(
    env_name, logdir, n_epochs, num_cpu, seed, replay_strategy, policy_save_interval, clip_return, expert_file,
    override_params={}, save_policies=True, render=False, max_test=True, level=0
):
    ...
    rollout_worker = RolloutImitator(params['make_env'], policy, expert, dims, logger, **rollout_params)
    ...
    train(
        logdir=logdir, policy=policy, expert=expert, rollout_worker=rollout_worker,
